...
def proses_google_sheet():
    ...
    # Semua row data diproses, termasuk row yang hidden atau terkena filter.
    ...
    print("Mode                 : SEMUA ROW (termasuk hidden / filtered)\n")
    ...
    print("Semua row diproses tanpa memperhatikan filter atau hidden row.\n")
